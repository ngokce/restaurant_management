...
CREATE TABLE `Rezervasyon` (
  ...
  `RezervasyonTarih` date DEFAULT NULL,
  `MusteriID` int DEFAULT NULL,
  PRIMARY KEY (`RezervasyonID`),
  KEY `MusteriID` (`MusteriID`),
  CONSTRAINT `rezervasyon_ibfk_1` FOREIGN KEY (`MusteriID`) REFERENCES `Musteriler` (`MusteriID`)
...
INSERT INTO `Rezervasyon` VALUES (1,1,'2023-12-21',170421841);
