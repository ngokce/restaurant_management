...
CREATE TABLE `calisanlar` (
  ...
  `CalisanAd` varchar(25) DEFAULT NULL,
  `CalisanMaas` int DEFAULT NULL,
  `BaslangicTarihi` date DEFAULT NULL,
  `Sifre` varchar(4) DEFAULT NULL,
...
INSERT INTO `calisanlar` VALUES (1,'Ahmet Kaya',200000,'2019-10-11','1234'),(2,'Nesrin Ozcan',30000,'2020-09-18','2341'),(3,'Pinar Su',15000,'2020-05-13','3412'),(4,'Deniz Ustun',15000,'2021-07-19','4123'),(5,'Cansel Ayanoglu',50000,'2019-12-03','4321');
